															...
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><a
																		...
																		target="_blank"><img alt="Logo"
																			...
																			style="display: block; height: auto; border: 0; width: 251px; max-width: 100%;"
																			title="Logo" width="251" /></a></div>
															</td>
														</tr>
													</table>
												</td>
						...
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f9d8ff; color: #000000; width: 640px;"
										width="640">
										<tbody>
											<tr>
												<td class="column column-1"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 60px; padding-bottom: 60px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="100%">
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		style="font-size: 14px; mso-line-height-alt: 16.8px; color: #0c2b5b; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: center;">
																			<span style="font-size:30px;"><strong>{{$especialista['name']}}</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: center;">
																			<span style="font-size:34px;"><strong>Tienes una nueva cita</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td
																...
																<div align="center" style="line-height:10px"><img
																		alt="Image" src="https://i.imgur.com/tVE3dFk.png"
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: center;">
																			<strong>{{$cita['dia']}} - {{$cita['hora_inicio']}} a {{$cita['hora_fin']}}</strong></p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			...
																			<span
																				style="font-size:20px;"><strong>Paciente:</strong></span>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: left;">
																			Email: {{$cita['paciente_email']}}</p>
																		<p
																			style="margin: 0; font-size: 14px; text-align: left;">
																			Telefono: {{$cita['paciente_telefono']}}</p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			...
																			<span
																				style="font-size:16px;">Servicio:<strong>
																					{{$cita->servicio->name_es}}</strong></span><br /><span
																				style="font-size:16px;">Modalidad:<strong>
																					{{$cita->modalidad->name_es}}</strong></span><br /><span
																				style="font-size:16px;">Valor:
																				<strong>{{$cita['valor']}} euros.</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
