...
<main id="main" class="main">
  @include('admin.policycookies.headersection',['title' => 'Crear política'])

    <div class="row">
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <form method="POST" action="{{ action('PolicyCookiesController@store') }}" enctype="multipart/form-data" class="submit-prevent-form">
            {{ csrf_field() }}
            <div class="card">
              @include('includes.form-error')
              <div class="card-header">Creación de política de cookies</div>
              <div class="card-body">
                <br>
