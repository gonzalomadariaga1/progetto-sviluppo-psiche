...
<main id="main" class="main">
    ...
    <form method="POST" action="{{ action('UsersController@update_permiso', $usuarios->id) }}" enctype="multipart/form-data" class="submit-prevent-form">
        {{csrf_field()}}
        {{ method_field('PATCH') }}
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-lg-2">
                        <a href="{{ url()->previous() }}" class="btn btn-primary-violet"><i class="bi bi-arrow-left"></i>     Volver</a>
                    </div>
