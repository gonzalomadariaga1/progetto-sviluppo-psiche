...
<main id="main" class="main">
  @include('admin.paquetes.headersection',['title' => 'Crear paquete'])

    <div class="row">
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <form method="POST" action="{{ action('PaquetesController@store') }}" enctype="multipart/form-data" class="submit-prevent-form">
            {{ csrf_field() }}
            <div class="card">
              @include('includes.form-error')
              <div class="card-header">Creación de paquete</div>
              <div class="card-body">
                <br>
                          ...
                          <div class="row">
                            <div class="col-lg-12  col-xs-12">
                                <div class="form-group">
                                    <input type="text" name="name_it" class="form-control"  placeholder="Paquete italiano" value="{{ old('name_it') }}" style="margin-top:5px;" >
                                </div>
                            </div>
                          </div> 
                        </div>
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">        
                          <div class="row">
                            <div class="col-lg-12  col-xs-12">
                                <div class="form-group">
                                    <input type="text" name="name_es" class="form-control"  placeholder="Paquete español" value="{{ old('name_es') }}" style="margin-top:5px;" >
                                </div>
                            </div>
                          </div> 
                        </div>
                    ...
                    <div class="col-lg-3 col-xs-12">
                      <div class="card">
                        ...
                        <div class="card-body mt-3">
                          ...
                          <div class="input-group">
                            <input type="number" name="descuento" class="form-control" placeholder="Ingrese descuento en euros" aria-label="Ingrese descuento en euros" aria-describedby="basic-addon2">
                            <span class="input-group-text" id="basic-addon2">euros</span>
                          </div>
