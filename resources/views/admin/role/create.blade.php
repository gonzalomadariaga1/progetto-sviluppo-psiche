...
<main id="main" class="main">
    ...
    <div class="row">
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <form method="POST" action="/roles" enctype="multipart/form-data" class="submit-prevent-form">
            {{ csrf_field() }}
            <div class="card">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-8 col-xs-12">
                          <div class="form-group">
                              ...
                              <br>
                              <input type="text" class="form-control" name="description" placeholder="Descripción del rol" id="description" value="{{ old('description') }}">
