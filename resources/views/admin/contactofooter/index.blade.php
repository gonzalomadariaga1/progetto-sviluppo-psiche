...
<main id="main" class="main">
  @include('admin.contactofooter.headersection',['title' => 'Sección Contacto del footer'])
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-10">
                    <h4>Sección de contacto del footer de la página de inicio.</h4>
                </div>
                ...
                <table id="tblarticulos" class="table table-striped table-bordered  table-hover" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{URL::action('ContactoFooterController@edit',$row['id'])}}" class="btn btn-primary-violet btn-sm mb-1" style="margin-right:3px;"><i class="bi bi-pencil-square"></i></a>
...
@section('code_js')
  <script>
      $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        var url = '{{ route("admin.contactofooter.destroy", ":id") }}';
