...
<main id="main" class="main">
  @include('admin.infofooter.headersection',['title' => 'Crear sección'])

    <div class="row">
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
          <form method="POST" action="{{ action('InfoFooterController@store') }}" enctype="multipart/form-data" class="submit-prevent-form">
            {{ csrf_field() }}
            <div class="card">
              @include('includes.form-error')
              <div class="card-header">Creación de sección info del footer</div>
              <div class="card-body">
                <br>
