...
@include('admin.carouseltarifas.headersection',['title' => 'Editar carousel'])

    <div class="row">
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
            <form method="POST" action="{{ action('CarouselTarifasController@update', $row->id) }}" enctype="multipart/form-data" class="submit-prevent-form">
                {{csrf_field()}}
                {{ method_field('PATCH') }}
            <div class="card">
              @include('includes.form-error')
              <div class="card-header">Editar carousel</div>
              <div class="card-body">
                <br>
                ...
                <div class="row">
                  <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <textarea id="editor_it" name="title_it"> {{old('title_it' , $row->title_it)}} </textarea>
                      </div>
                  ...
                  <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <textarea id="editor_it" name="title_es"> {{old('title_es' , $row->title_es)}} </textarea>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <textarea id="editor2_it" name="subtitle_it"> {{old('subtitle_it' , $row->subtitle_it)}} </textarea>
                      </div>
                  ...
                  <div class="col-lg-6 col-xs-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <textarea id="editor2_es" name="subtitle_es"> {{old('subtitle_es' , $row->subtitle_es)}} </textarea>  
                      </div>
