...
<script>
    ...
    payButton.addEventListener('click', async(e) => {
        paciente_nombres = document.getElementById('paciente_nombres').value;
        paciente_apellidos = document.getElementById('paciente_apellidos').value;
        paciente_email = document.getElementById('paciente_email').value;

        nombre_completo = paciente_nombres + " " + paciente_apellidos ;
